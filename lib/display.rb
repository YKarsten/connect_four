...
# This holds blocks of text that are displayed to the user
module Display
  def display_intro
    "Let's play a simple connect-4 game in the console! \n\n"
  end
  ...
  def display_player_turn(name, symbol)
    "#{name}, please enter a number (0-6) that is available to place an '#{symbol}'"
  end
